...
#flair.set_seed(100)
filename_results = 'results_ConfScores_Stackoverflow_seedset_2.txt'
filename_model = 'resources/taggers/Random10'
filename_model2 = 'resources/taggers/ConfScores10'
device = 'cuda:0'
SeedSet = True
shuffle = True
