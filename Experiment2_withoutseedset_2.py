...
def write(name, contents):
    with open('results_EGL_withoutseedset_2.txt', 'w', encoding='utf-8') as f:
        f.write('\n'.join(contents))
...
#ExpectedGradientLength.trainTARS(path = 'resources/taggers/ExpectedGradientLength2')
...
for i in range(10):
    ...
    ExpectedGradientLength.trainTARS(path = 'resources/taggers/ExpectedGradientLength4')
    ExpectedGradientLengthAccuracy_seed.append(ExpectedGradientLength.evaluateModel())
